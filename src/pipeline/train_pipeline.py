...
class TrainingPipeline:
    ...
    def start_data_transformation(self, feature_store_file_path):
        try:
            ...
            raise CustomException(e,sys)
    def start_model_training(self, train_arr, test_arr, preprocessor_file_path):
        try:
            model_trainer= ModelTrainer()
            model_trainer_path=model_trainer.initiate_model_trainer(train_arr, test_arr)
            return model_trainer_path, preprocessor_file_path
        except Exception as e:
            raise CustomException(e,sys)
